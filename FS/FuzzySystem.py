...
class FuzzySystem:
    ...
    def fuzzy2(self):
        ...
        fuzzy_arr = [0.6529423, 0.41547966, 1.0, 0.48941815, 26.449348, 10.586154, 25.257536, 19.886314, 21.690737, 9.0730324, 30.0, 30.0, 24.744194, 9.6203585, 10.0, 6.0890045]
        for i in range(len(fuzzy_arr)):
            fuzzy_arr[i] = (fuzzy_arr[i]-0.5) * 80.0
            if fuzzy_arr[i] >= 40.0:
                fuzzy_arr[i] = 40.0
            elif fuzzy_arr[i] <= -40.0:
                fuzzy_arr[i] = -40
            else:
                pass
